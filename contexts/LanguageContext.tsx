...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "pos.manage_categories": "Manage Categories",
    "pos.cat_new": "New Category",
    "pos.cat_edit": "Edit Category",
    "pos.cat_name": "Category Name",
    "pos.cat_icon": "Icon Name (Material Symbols)",
    "pos.cat_id": "Category ID (lowercase, no spaces)",
    ...
    "checkout.print_bill": "Print Receipt",
    "checkout.bill_header": "EcoPOS Receipt",
    "checkout.bill_thankyou": "Thank you for dining with us!",
  ...
  vi: {
    ...
    "pos.manage_categories": "Quản lý danh mục",
    "pos.cat_new": "Danh mục mới",
    "pos.cat_edit": "Sửa danh mục",
    "pos.cat_name": "Tên danh mục",
    "pos.cat_icon": "Tên Icon (Material Symbols)",
    "pos.cat_id": "ID danh mục (viết thường, không dấu)",
    ...
    "checkout.print_bill": "In hóa đơn",
    "checkout.bill_header": "Hóa Đơn EcoPOS",
    "checkout.bill_thankyou": "Cảm ơn quý khách!",
  ...
  fr: {
    ...
    "pos.manage_categories": "Gérer les catégories",
    "pos.cat_new": "Nouvelle catégorie",
    "pos.cat_edit": "Modifier catégorie",
    "pos.cat_name": "Nom de catégorie",
    "pos.cat_icon": "Nom de l'icône",
    "pos.cat_id": "ID de catégorie",
    ...
    "checkout.print_bill": "Imprimer le reçu",
    "checkout.bill_header": "Reçu EcoPOS",
    "checkout.bill_thankyou": "Merci d'avoir dîné avec nous!",
